...
# Преобразую строку в список строк. Последний элемент еще преобразую с список

vlans1 = command1.split(' ')[-1].split(',')
vlans2 = command2.split(' ')[-1].split(',')

# Получу множества из список, и вычислю их пересечения с помощью & (intersections). Оссортирую результат
